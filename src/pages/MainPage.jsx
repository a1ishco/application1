...
export default function MainPage() {
  ...
  function handleClick() {
    setShow(true)
    var FETCH_URL = 'http://api.weatherapi.com/v1/current.json?key=a3b5720f8c00466f91a142434231807&q=' + inputValue + '&aqi=no';
  ...
  if ((hour >= 6 && hour <= 20)) {
    mode = "card mt-5 col-6 bg-light text-dark"
  }
...
<div className="headerText mt-5">
    <h1>Weather for today</h1>
        ...
        <div className={show ? 'd-flex text-center justify-content-center' : 'd-none'}>
        <div className={mode}>
